...
def get_args_parser():
    ...
    parser.add_argument('--focal_alphas', nargs='+', type=float, default = [1.0], help='List of focal alpha values for categories')
...
if __name__ == "__main__":
    ...
    coco_dataset = CocoDetection(args.coco_path, args.dataset_file, transforms=None, return_masks=args.masks)
    focal_alphas = coco_dataset.get_focal_alphas()
